...
function resetGame() {
    ...
    container.innerHTML = `
        <div class="container-game-info">
            <div class="container-bullets">
                <h2 id="bullets">bullets:</h2><h2 id="bullets-num">${bullets}</h2>
            </div>
            <div class="container-timer">
                <h2 id="timer">timer:</h2><h2 id="timer-num">${timerCount}</h2>
            </div>
            <div class="container-score">
                <h2 id="score">score:</h2><h2 id="score-num">${score} / ${maxScore}</h2>
            </div>
        </div>
    ...
    // Re-capture necessary elements after container reset
...
function endGame() {
    ...
    <div class="container-collect-cgun">
        ...
        <h3 style="color:white">You collected ${score * 2} $CGUNs</h3>
        <button id="play-again-btn" onclick="resetGame()">Play Again</button>
    </div>
    `;
}

// Remove collectCgun function as it's no longer needed
